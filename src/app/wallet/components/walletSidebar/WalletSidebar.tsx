...
import { Grid, Menu, Button, Dropdown, Divider, Image } from 'semantic-ui-react';
import { NavLink, withRouter, Link } from 'react-router-dom';
import { connect } from 'react-redux';
import { TerraConnect } from '../../../terra/terraConnect';
import * as scatterActions from '../../../scatter/scatterActions';
const scatterIcon = require('../../../../staticAssets/images/scatter-icon.svg');
const meetoneIcon = require('../../../../staticAssets/images/meetone_wallet_logo.svg');
const lynxIcon = require('../../../../staticAssets/images/eos_lynx_wallet_logo.svg');
const tpIcon = require('../../../../staticAssets/images/tp-icon.svg');
const wombatIcon = require('../../../../staticAssets/images/wombat_icon.svg');
...
class WalletSidebar extends Component<IProps, IState>  {
  ...
  render() {
    ...
    return (
      <Grid.Column width="3" className="wallet-menu-container cz-menu-side-bar">
        ...
        <Menu vertical className="vertical-wallet-menu hide-tablet cz-sidebar-menu">
          <Menu.Item>
            <p className="active bold"><b>Wallet</b></p>
          </Menu.Item>
          <Menu.Item>
            <NavLink to="/wallet" exact activeClassName="active">Dashboard</NavLink>
          </Menu.Item>
          <Menu.Item>
            <Link to="/wallet/powerup" exact activeClassName="active"><Image src="/img/newsFeed.svg" /> Power up</Link>
          </Menu.Item>
          <Menu.Item>
            <NavLink to="/wallet/payout" exact activeClassName="active"><Image src="/img/newsFeed.svg" /> Weekly Payout</NavLink>
          </Menu.Item>
          <Menu.Item>
            <NavLink to="/wallet/staking" exact activeClassName="active"><Image src="/img/newsFeed.svg" /> Staking (legacy)</NavLink>
          </Menu.Item>
          {/*
          <Menu.Item>
          ...
          {acctName && (
            <Menu.Item className="account">
              <NavLink to="/profile/settings" exact activeClassName="active"><Image src="/img/newsFeed.svg" /> Settings</NavLink>
            </Menu.Item>
          )}
          <Menu.Item />
          <Menu.Item>
          ...
          <Divider />
          <Menu.Item>
            <a href="https://eos.staker.one" target="_blank" rel="noopener noreferrer"><Image src="/img/newsFeed.svg" /> Staker.One</a>
          </Menu.Item>
          {isAdmin && (isAdmin.administrator) && (
            <div>
              ...
              <Divider />
              <Menu.Item>
                <NavLink to="/wallet/withdraws" exact activeClassName="active"><Image src="/img/newsFeed.svg" /> Pending Withdraws</NavLink>
              </Menu.Item>
            </div>
          )}
        </Menu>
